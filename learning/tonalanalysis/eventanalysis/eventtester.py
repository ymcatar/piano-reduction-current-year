...
TEST_SCORES_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'test_scores')
...
class EventTester:
    ...
    def __init__(self, file_name):
        ...
        self._file_path = os.path.join(TEST_SCORES_DIR, file_name)
    ...
    def load_result_file(self):
        ...
        self._result_fp = open(os.path.join(TEST_SCORES_CORRECT_DATA_DIR, self._file_name_no_ext + ".txt"))
